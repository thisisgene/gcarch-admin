...
export const UPLOAD_PROJECT_IMAGES = 'UPLOAD_PROJECT_IMAGES'
export const UPLOAD_NEWS_IMAGES = 'UPLOAD_NEWS_IMAGES'
export const UPLOAD_TEAM_IMAGES = 'UPLOAD_TEAM_IMAGES'
export const DELETE_IMAGE = 'DELETE_IMAGE'
export const DELETE_NEWS_IMAGE = 'DELETE_NEWS_IMAGE'
export const DELETE_TEAM_IMAGE = 'DELETE_TEAM_IMAGE'
